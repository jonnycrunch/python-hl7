...
def parse(line: Content, encoding: str = "utf-8", factory=containers.Factory) -> containers.Message:
...
class _ParsePlan(object):
    ...
    def __init__(self, separators: List[str], containers: List[containers.Container], esc:str, factory: containers.Factory):
